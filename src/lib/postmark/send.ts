...
const BROADCAST_TEMPLATE_ALIASES: ReadonlySet<StarterTemplateAlias> = new Set(["broadcast-update"]);
...
export async function sendTemplatedEmail<T extends StarterTemplateAlias>(
  ...
  return client.sendEmailWithTemplate({
    ...
    MessageStream: args.messageStream ?? defaultMessageStreamForTemplate(args.templateAlias),
